...
COMPRESS      = gzip -9f
DISTNAME      = game1.0.0
DISTDIR = /cygdrive/c/Users/user/AppData/Roaming/SPB_16.6/E14061313/game/.tmp/game1.0.0
LINK          = g++
LFLAGS        = 
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ball.h breakout.h brick.h stick.h $(DISTDIR)/
	$(COPY_FILE) --parents ball.cpp breakout.cpp brick.cpp main.cpp stick.cpp $(DISTDIR)/
...
breakout.o: breakout.cpp breakout.h \
		ball.h \
		brick.h \
		stick.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o breakout.o breakout.cpp

brick.o: brick.cpp brick.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o brick.o brick.cpp

main.o: main.cpp breakout.h \
		ball.h \
		brick.h \
		stick.h
...
stick.o: stick.cpp stick.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o stick.o stick.cpp
